        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            using (var context = new DatabaseContext(serviceProvider.GetRequiredService<DbContextOptions<DatabaseContext>>()))
            {
                ...
                context.Drivers.AddRange(
                    ...
                    new Driver { Id = "1", FirstName = "Vindya", LastName = "Hettige", Age = 29, NIC = "323232", VehicleId = "4" },
                    new Driver { Id = "1", FirstName = "Prageesha", LastName = "Tennakoon", Age = 29, NIC = "232323", VehicleId = "3" },
                    new Driver { Id = "1", FirstName = "Shanika", LastName = "Tennakoon", Age = 29, NIC = "3232324", VehicleId = "5" }
